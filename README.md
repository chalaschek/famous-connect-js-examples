#famous-connect-js-examples
> Famo.us: The Future of the Mobile Web? - Connect.JS 2014 Talk Examples.

[![Build Status](https://travis-ci.org/chalaschek/famous-connect-js-examples.svg?branch=master)](https://travis-ci.org/chalaschek/famous-connect-js-examples) [![Dependency Status](https://david-dm.org/chalaschek/famous-connect-js-examples.svg)](https://david-dm.org/chalaschek/famous-connect-js-examples) [![devDependency Status](https://david-dm.org/chalaschek/famous-connect-js-examples/dev-status.svg)](https://david-dm.org/chalaschek/famous-connect-js-examples#info=devDependencies)
...
## Release History
 * 2014-10-16   v0.1.0   Generated by the [Yeoman Generator](https://github.com/FamousTools/generator-famous) for [Famo.us](http://famo.us)